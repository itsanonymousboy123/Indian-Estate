  ...
  return (
    <div className='p-4 max-w-lg mx-auto bg-white rounded-lg shadow-md'>
      ...
      <button
        ...
        className='bg-green-700 text-white w-full p-3 rounded-lg uppercase hover:opacity-95'
      >
        Show Listings
      </button>
      ...
      {userListings && userListings.length > 0 && (
        <div className='flex flex-col gap-4 mt-6'>
          ...
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className='border border-gray-300 rounded-lg p-3 flex justify-between items-center gap-4 bg-white shadow-sm'
            >
